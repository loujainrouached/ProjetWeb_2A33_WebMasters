    ...
    <div class="container">
     / <input type="hidden" name="id_user" value="<?php echo $_POST['id_user']; ?>">
       ...
       <select class="form-control" name="nature_user" id="nature_user">
        <option value="client" <?php if ( $userData['nature_user'] == 'client') echo 'selected'; ?>>client</option>
          <option value="Admin" <?php if ( $userData['nature_user'] == 'Admin') echo 'selected'; ?>>Admin</option>
          </select>
        <div class="row justify-content-center">
<div class="col-md-6">  
