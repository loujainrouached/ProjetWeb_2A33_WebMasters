...
require_once _DIR_.'/../Controller/articleC.php';
require_once _DIR_.'/../model/articleM.php';
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>commentaires</a>
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="listecommentaire.php" class="dropdown-item">liste des commentaire</a>
