...
// Instancier votre classe ReclamationsC
$reclamationsC = new ReclamationsC();

// Appeler la fonction pour compter les réclamations non lues
$unreadCount = $reclamationsC->countUnreadReclamations();
?>
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                        ...
                        $unreadReclamations = $reclamationsC->listUnreadReclamationsAdmin();
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">les utulisateurs de notre</h6>
                        <a href="">Show All</a>
                    </div>
