                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating">
                                <input type="date" class="form-control border-0" id="date_reponse" placeholder="Date" name="date_reponse">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control border-0" placeholder="votre reponse" id="rep" name="rep"></textarea>
                                <label for="rep">Votre reponse</label>
                                
                            </div>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary w-100 py-3" type="submit" value="Save" name="valider" >Send rep</button>
                        </div>
                        <div class="col-12">
