...
if (
    ...
    if (
        ...
        $commentaire = new commentaire(
            ...
            $commentaireC->updatecommentaire($commentaire,$_GET ['ID_commentaire'],$_SESSION['id_user']);
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-end mb-md-0">
                        <i class="fas fa-copyright me-2"></i><a class="text-white" href="#">VieExplore</a>, your trip advisor !
                    </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">ajouter un commentaire</h6>
                        <a href="">Show All</a>
                    </div>
                    <div class="table-responsive">
                        ...
                        <form action="" method="POST">
                            <tr>
                                <td><label for="contenu_commentaire">contenu_commentaire :</label></td>
                                <td>
                                    <textarea type="text" id="contenu_commentaire" name="contenu_commentaire" ></textarea>
                                    <span id="erreur_contenu_commentaire" style="color: red"></span>
                                </td>
                            </tr>

                            <tr>
                                <td><label for="date_de_publication_">date_de_publication_:</label></td>
                                <td>
                                    <input type="date" id="date_de_publication_" name="date_de_publication_" />
