...
if ($_SERVER["REQUEST_METHOD"] == "POST" ) {
   ...
   $message = "Un email va être envoyé à $email ";
...
<div class="container" >
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
        <div class="mb-3">
            ...
            <input type="email" id="email" name="email" placeholder="entrer L'adresse mail">
        </div>
    ...
    <?php if ($showVerificationForm) : ?>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                <div class="mb-3">
                    ...
                    <input type="code" id="code" name="code" placeholder="entrer Le code">
                </div>
