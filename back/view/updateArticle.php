...
require_once __DIR__.'/../model/articleM.php';
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        ...
                        <form action="" method="POST">
                            <table>
                            <tr>
                                    <td><label for="titre_article">id_article :</label></td>
                                    <td>
                                        <input type="text" id="id_article" name="id_article" value="<?php echo  $article['id_article'] ?>" readonly />
