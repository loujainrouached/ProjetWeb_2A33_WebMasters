...

{
    ...
    function addReclamations($Reclamations, $id_user)
    {
        $sql = "INSERT INTO reclamations(id_user, date_reclamation, titre_reclamation, contenu, vue_par_admin) 
                VALUES ( :id_user, :date_reclamation, :titre_reclamation, :contenu, 0)";
        $db = config::getConnexion();
        try {
