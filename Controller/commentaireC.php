...
public function add_commentaire($commentaire, $id_user)
{
    $sql = "INSERT INTO commentaire (ID_commentaire, id_article, id_user, contenu_commentaire, date_de_publication_) VALUES (:ID_commentaire, :id_article, :id_user, :contenu_commentaire, :date_de_publication_)";
    $db = config::getConnexion();
    try {
    ...
    function updatecommentaire($commentaire, $id,$id_user)
    {   
